...
make lintmd       # Run markdownlint (targets: docs/, docs-rules/, .claude/, .clinerules/, .AI/, .github/, *.md; runs on host)
make lintmdfix    # Run markdownlint with --fix (targets: docs/, docs-rules/, .claude/, .clinerules/, .AI/, .github/, *.md; runs on host)
make checklinks   # Check for broken links (targets: docs/, docs-rules/, .claude/, .clinerules/, .AI/, .github/; external URLs excluded; runs on host)
