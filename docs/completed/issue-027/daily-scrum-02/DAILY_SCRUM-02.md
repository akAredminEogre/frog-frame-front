...
- [x] ElementSelector.test.tsにテーブル関連テストケースを追加した
- [x] isTableElementメソッドの単体テストを実装した
- [x] isWithinTableメソッドの単体テストを実装した
- [x] テーブル内要素選択の統合テストを実装した
- [x] 既存機能への影響確認テストを実行した
- [x] npm run testでテストが全てパスすることを確認した
