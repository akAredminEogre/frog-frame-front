...
- [x] テスト用HTMLファイルを作成して手動テスト環境を準備 ✅ スクラム03完了
- [x] 単一要素内のテキスト選択の動作を手動で確認 ✅ スクラム03完了
- [x] 複数要素にまたがるテキスト選択の動作を手動で確認 ✅ スクラム03完了
- [x] ネストした要素での選択の動作を手動で確認 ✅ スクラム03完了
- [x] エッジケース（選択なし、特殊文字など）を手動で確認 ✅ スクラム03完了
...
- [x] ユーザーストーリーのHTMLサンプルを用いた手動テストを実行
