...
下記のエラーに対応してください
```
akaredmineogre@MSI:~/akAredminEogre-project/favorite-keyword-link-frog$ cd /home/akaredmineogre/akAredminEogre-project/favorite-keyword-link-frog && docker compose exec frontend npm run storybook
