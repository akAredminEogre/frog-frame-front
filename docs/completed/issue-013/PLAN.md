...
1. **ElementSelector.tsの修正** ✅
   - [x] `getElementFromSelection()`メソッドの改善
   - [x] 親要素遡及処理の追加
   - [x] 複数テキストノード対応
...
- [x] **期待する動作の実現**: span要素内のテキストを右クリックした際、span要素全体が取得される
- [x] **単体テストの作成**: 新しいケースに対応するテストケースの作成と通過
- [x] **既存テストの維持**: 既存のユニットテスト、e2eテストが通る
