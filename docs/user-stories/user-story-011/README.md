...
- [x] MD001(見出しレベル階層スキップ)違反の修正 (docs/配下は段階的に修正)
- [x] MD040(言語指定なし/許可外言語)違反の修正 (docs/配下は段階的に修正)
...
- [x] `.github/` ディレクトリをmarkdownlint対象に追加・違反修正
- [x] `.github/` ディレクトリをchecklinks対象に追加・違反修正
